...
def _summarize_task_result(result: dict) -> str:
    ...
    summary_keys = [
        ...
        "final_eligible_count_after_lookup",
        "base_candidates_needing_live_check_count",
        "customers_to_lookup_count",
        "checked_count",
        "clean_count",
        "blocked_by_trustpilot_history_count",
        "failed_or_incomplete_count",
        "skipped_duplicate_customer_count",
        "needs_live_customer_history_check_count",
        "live_checks_completed_count",
        "live_checks_blocked_count",
        ...
        "json_on_demand_customer_history_lookup_path",
        "html_on_demand_customer_history_lookup_path",
        "json_shopify_scope_verification_path",
        "html_shopify_scope_verification_path",
        "json_shopify_oauth_reauthorization_helper_path",
        "html_shopify_oauth_reauthorization_helper_path",
        "oauth_reauthorization_helper_status",
        "helper_script_present",
        "token_save_requires_approval_flag",
        "env_backup_created_by_helper_when_saving",
        ...
        "lookup_status",
        "local_order_found",
        "local_customer_history_count",
        "shopify_api_lookup_performed",
        "read_orders_scope_present",
        "read_all_orders_scope_present",
        "customer_history_permission_status",
        "shopify_customer_history_count",
        "shopify_history_order_names",
        "trustpilot_note_evidence_found",
        "trustpilot_tag_evidence_found",
        "evidence_order_name",
        "safe_detected_keyword",
        "final_recommendation",
        "should_block_review_send",
        "blocking_reason",
