...
$ExternalRoutingRecommendedNextPath = "final manual Cloudflare cutover checklist / operator approval; conservative recommendation Option B, not approved"
...
function Show-DeploymentLockStatus {
    ...
    Write-Host "Production apply remains blocked until the final manual Cloudflare cutover checklist / operator approval is complete and exact runtime commands based on the documented defaults are implemented, reviewed, approved, and covered by manual production approval."
...
function Show-FuturePlan {
    ...
    Write-Host "Production apply remains blocked until the final manual Cloudflare cutover checklist / operator approval is complete and exact runtime commands based on the documented defaults are implemented, reviewed, approved, and covered by manual approval."
    Write-Host "No Cloudflare/domain routing change is approved without separate approval."
    Write-Host "No host port 8000 ownership change is approved without separate approval."
...
Write-Ok "Production blue-green real apply remains NO-GO until the final manual Cloudflare cutover checklist / operator approval is complete and a separate future phase approves exact runtime commands behind deployment lock gates."
